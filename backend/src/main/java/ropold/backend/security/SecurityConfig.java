...
public class SecurityConfig {
    ...
    private static final String PIECE_IMAGE = "/api/piece-image/**";
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(a -> a
                        .requestMatchers(HttpMethod.GET, PIECE_IMAGE).permitAll()
                        .requestMatchers(HttpMethod.POST, PIECE_IMAGE).authenticated()
                        .requestMatchers(HttpMethod.PUT, PIECE_IMAGE).authenticated()
                        .requestMatchers(HttpMethod.DELETE, PIECE_IMAGE).authenticated()
